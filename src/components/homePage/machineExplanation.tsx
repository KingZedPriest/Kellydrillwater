...
export default function Machines(){
    return(
        <main className="md:px-18 bg-white px-6 py-32 sm:px-12 lg:px-12 overflow-hidden">
            ...
            <div className="flex flex-wrap justify-center gap-x-[6.5rem] xl:gap-x-[8rem] gap-y-10 mt-14">
                <div className="w-[18rem] border border-black/5 h-[25rem] md:h-[23rem] rounded-xl card relative group">
