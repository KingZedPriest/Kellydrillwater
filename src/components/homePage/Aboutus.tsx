...
const Aboutus = () => {
    return ( 
        <main className="flex flex-col-reverse items-center gap-10 lg:flex-row lg:justify-between px-6 sm:px-12 lg:px-24 md:px-18">
            <div className="lg:w-1/2 flex flex-col gap-y-10">
                ...
                <Link href="/about" className="mt-4 bg-secAccentColor text-center text-white rounded-md w-44 py-3 border border-secAccentColor hover:bg-white hover:text-secAccentColor duration-300">Read More</Link>
            </div>
